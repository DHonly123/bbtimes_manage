    <%@page import="com.cdqidi.bb.comm.util.PropertiesFactoryHelper"%>
<%@ page language="java" pageEncoding="utf-8"%>
    ...
    <%
    	...
    	for(int i=0;i<arr.length;i++){
    		...
    		String realPath = propFactory.getConfig("UploadFileSavePath");
			File f = new File(realPath);
			String savePath = f.getAbsolutePath() + "/"+filePath;
    		//格式验证
